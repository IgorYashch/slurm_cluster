...
X_train_cats = pd.read_pickle('data/version_2/X_train_cats.pickle')
X_test_cats = pd.read_pickle('data/version_2/X_test_cats.pickle')
...
xgb_model = XGBRegressor(**{'colsample_bytree': 0.7, 'learning_rate': 0.01, 'max_depth': 3, 'n_estimators': 500})
